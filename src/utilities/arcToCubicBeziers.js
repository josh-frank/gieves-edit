...
const arcToCubicBeziers = ( previousPoint, [ ellipseRadiusX, ellipseRadiusY, xAxisRotation = 0, largeArcFlag = 0, sweepFlag = 0, nextPointX, nextPointY ] ) => {
    const curves = [];
    ...
    // round to 1.0 when the ratio is close to 1.0
    let ratio = Math.abs( thatAngle ) / ( TAU / 4 );
...
module.exports = { arcToCubicBeziers };
...
// const testPath = [
//     [ "M", 724, 482 ],
//     [ "A", 45, 45, 90, 0, 1, 654, 506 ],
//     [ "Z" ]
// ];

// const normalizedTestPath = [
//     [ "M", 724, 482 ],
//     [ "C", 719.987203448301, 496.21169979271434, 709.2569639775744, 507.55011557511557, 695.2878388271141, 512.3395299124163 ],
//     [ "C", 681.3187136766538, 517.1289442497169, 665.8887223508157, 514.7597504547093, 654, 506 ],
//     [ "Z" ]
// ];

// const curves = arcToCubicBeziers( [ 724, 482 ], [ 45, 45, 90, 0, 1, 654, 506 ] );
